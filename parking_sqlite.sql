...
CREATE TABLE IF NOT EXISTS "session" (
	...
	CONSTRAINT FK_session_station_2 FOREIGN KEY (exit_station) REFERENCES station(id),
	CONSTRAINT FK_session_station_3 FOREIGN KEY (entry_station) REFERENCES station(id),
	CONSTRAINT FK_session_ticket_4 FOREIGN KEY (ticket_id) REFERENCES ticket(id)
);
...
CREATE TABLE payment (
	...
	CONSTRAINT FK_payment_session FOREIGN KEY (session_id) REFERENCES "session"(id),
	CONSTRAINT FK_payment_station_2 FOREIGN KEY (station_id) REFERENCES station(id)
);
